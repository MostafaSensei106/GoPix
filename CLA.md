...
submitted to the GoPix project.

GoPix is an open-source project intended to remain free, public, and
...
- GoPix will remain an **open-source project**
...
- All Contributions will be made publicly available under the
  **GNU General Public License (GPL)** as part of GoPix.
...
Submitting a Contribution to GoPix means you accept this Agreement.
